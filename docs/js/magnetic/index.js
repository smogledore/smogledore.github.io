(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["giaCursorDistance"] = factory();
	else
		root["giaCursorDistance"] = factory();
})(window, function() {
...
var _Distance = function (_Component) {
    _inherits(_Distance, _Component);

    function _Distance() {
        _classCallCheck(this, _Distance);

        return _possibleConstructorReturn(this, (_Distance.__proto__ || Object.getPrototypeOf(_Distance)).apply(this, arguments));
    }

    _createClass(_Distance, [{
        key: 'render',
        value: function render(distance, x, y) {
        ...
        value: function mount() {
            ...
            this.mousemoveHandler = (0, _throttle2.default)(this.mousemove.bind(this));
        ...
        value: function mousemove(event) {
            var distance = this.getDistance(event.clientX + window.scrollX, event.clientY + window.scrollY);
...
var _BaseComponent2 = __webpack_require__(9);
